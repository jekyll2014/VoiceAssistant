...
{
    public class AppControlPlugin : PluginBase
    {
        private readonly Dictionary<string, int> keyList = new Dictionary<string, int>
        {
            {"VK_LBUTTON", 0x01},
            {"VK_RBUTTON", 0x02},
            {"VK_CANCEL", 0x03},
        ...
        {
            var configBuilder = new Config<AppControlPluginSettings>($"{PluginPath}\\{PluginConfigFile}");
            ...
            KeyNotFound = configBuilder.ConfigStorage.KeyNotFound;
            ProcessNotFound = configBuilder.ConfigStorage.ProcessNotFound;
        }
